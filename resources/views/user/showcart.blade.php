...
<div align="centr" class="alert alert-success d-flex justify-end " style="width: 300px">
  <button type="button" class="btn-close d-flex justify-end" data-dismiss="alert" >X</button>
  {{ session()->get('message') }}
</div>
    ...
    <div style="padding: 100px;" align="center">
        <table>
            ...
            @endforeach
             ...
             <button type="submit" class="btn btn-success  mt-4 bg-success">Confirm Order</button> 
      </form>
